...
class pico_lobby
{
	...
	jmethodID get_transform_matrix_method = nullptr;
	JavaVM *tex_vm = nullptr;
...
public:
	...
	void set_surface_texture(JNIEnv *env, jobject st, jmethodID update_method);
