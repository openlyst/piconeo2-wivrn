# RC6 (unreleased)
 ...
 - Switch to async MediaCodec callbacks when available (API 28+), eliminating output polling thread and reducing decode latency; falls back to sync polling on API 27
