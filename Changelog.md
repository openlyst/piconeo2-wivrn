# RC6 (unreleased)
 ...
 - Fix floaty controller tracking: reduce velocity filter time constants (100ms/50ms → 20ms), increase prediction scale (0.4 → 0.7), and select frames by predictedDisplayTime instead of always using the latest
